...
class WallE():
    ...
    def callback(self,msg):
        ...
        self.angle= -0.2 #self.getSteeringCmd(error, -1, 1)
    ...
    def __init__(self):
        ...
        #for Gazebo, the topic is incorrect, and need to use this one
        ...
        speed = 0.8 # constant travel speed in meters/second
        angle = 0.1
