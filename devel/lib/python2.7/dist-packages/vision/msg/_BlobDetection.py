...
"""autogenerated by genpy from vision/BlobDetection.msg. Do not edit."""
import sys
...
class BlobDetection(genpy.Message):
  _md5sum = "4757db88dec50fec01a1ad0746758859"
  _type = "vision/BlobDetection"
...
float64 z
"""
  __slots__ = ['header','colors','sizes','locations']
  _slot_types = ['std_msgs/Header','std_msgs/ColorRGBA[]','std_msgs/Float64[]','geometry_msgs/Point[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BlobDetection, self).__init__(*args, **kwds)
